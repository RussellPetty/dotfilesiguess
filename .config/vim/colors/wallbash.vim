...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  if s:is_dark
    let g:terminal_ansi_colors = ['2E3440', '657DA3', '7A92C2', '7A93C2',
                                \ '6579A3', '9AB4E6', '9AB3E6', 'FFFFFF',
                                \ '3C4352', '7A96C2', '9AB3E6', 'AAC2F0',
                                \ '7A91C2', 'AAC2F0', 'AAC1F0', 'FFFFFF']
  else
    " Lighter colors for light theme
    let g:terminal_ansi_colors = ['FFFFFF', '9AB7E6', 'AAC1F0', 'AAC2F0',
                                \ '9AB2E6', 'CCDEFF', 'CCDDFF', '4A5467',
                                \ 'FFFFFF', 'AAC5F0', 'CCDDFF', 'CCDEFF',
...
if &background == 'dark'
  ...
  hi Pmenu guibg=#4A5467 guifg=#FFFFFF gui=NONE cterm=NONE
  hi StatusLine guifg=#FFFFFF guibg=#4A5467 gui=NONE cterm=NONE
  hi StatusLineNC guifg=#FFFFFF guibg=#3C4352 gui=NONE cterm=NONE
  ...
  hi NeoTreeWinSeparator guifg=#3C4352 guibg=NONE gui=NONE cterm=NONE
  ...
  hi TabLine guifg=#FFFFFF guibg=#4A5467 gui=NONE cterm=NONE
  hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi TabLineSel guifg=#2E3440 guibg=#CCDDFF gui=bold cterm=bold
  hi TabLineSeparator guifg=#657AA3 guibg=#4A5467 gui=NONE cterm=NONE

  " Interactive elements with dynamic contrast
  hi Search guifg=#3C4352 guibg=#AAC1F0 gui=NONE cterm=NONE
  hi Visual guifg=#3C4352 guibg=#9AB3E6 gui=NONE cterm=NONE
  hi MatchParen guifg=#3C4352 guibg=#CCDDFF gui=bold cterm=bold
  ...
  hi WhichKeyFloat guibg=#3C4352 guifg=NONE gui=NONE cterm=NONE

  " Selection and hover highlights with inverted colors
  hi CursorColumn guifg=NONE guibg=#4A5467 gui=NONE cterm=NONE
  ...
  hi QuickFixLine guifg=#3C4352 guibg=#9AB3E6 gui=NONE cterm=NONE
  hi IncSearch guifg=#3C4352 guibg=#CCDDFF gui=NONE cterm=NONE
  hi NormalNC guibg=#3C4352 guifg=#FFFFFF gui=NONE cterm=NONE
  hi Directory guifg=#AAC1F0 guibg=NONE gui=NONE cterm=NONE
  hi WildMenu guifg=#3C4352 guibg=#CCDDFF gui=bold cterm=bold

  " Add highlight groups for focused items with inverted colors
  hi CursorLineFold guifg=#CCDDFF guibg=#3C4352 gui=NONE cterm=NONE
  hi FoldColumn guifg=#FFFFFF guibg=NONE gui=NONE cterm=NONE
  hi Folded guifg=#FFFFFF guibg=#4A5467 gui=italic cterm=italic
  ...
  hi NeoTreeGitDeleted guifg=#657DA3 guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitUntracked guifg=#7A93C2 guibg=NONE gui=NONE cterm=NONE
  ...
  hi WinBar guifg=#FFFFFF guibg=#4A5467 gui=bold cterm=bold
  hi WinBarNC guifg=#FFFFFF guibg=#3C4352 gui=NONE cterm=NONE
  ...
  hi BufferCurrentSign guifg=#CCDDFF guibg=#3C4352 gui=NONE cterm=NONE
  hi BufferVisible guifg=#FFFFFF guibg=#4A5467 gui=NONE cterm=NONE
  hi BufferVisibleMod guifg=#FFFFFF guibg=#4A5467 gui=NONE cterm=NONE
  hi BufferVisibleSign guifg=#9AB3E6 guibg=#3C4352 gui=NONE cterm=NONE
  hi BufferInactive guifg=#FFFFFF guibg=#3C4352 gui=NONE cterm=NONE
  hi BufferInactiveMod guifg=#657AA3 guibg=#3C4352 gui=NONE cterm=NONE
  hi BufferInactiveSign guifg=#657AA3 guibg=#3C4352 gui=NONE cterm=NONE
  ...
  hi SignColumn guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi FoldColumn guifg=#3C4352 guibg=NONE gui=NONE cterm=NONE
  ...
  hi CmpItemMenu guifg=#3C4352 guibg=NONE gui=italic cterm=italic
  hi CmpItemAbbr guifg=#2E3440 guibg=NONE gui=NONE cterm=NONE
  hi CmpItemAbbrDeprecated guifg=#4A5467 guibg=NONE gui=strikethrough cterm=strikethrough

  " Specific menu highlight groups
  hi WhichKey guifg=#293652 guibg=NONE gui=NONE cterm=NONE
  hi WhichKeySeparator guifg=#4A5467 guibg=NONE gui=NONE cterm=NONE
  ...
  hi NormalNC guibg=#FFFFFF guifg=#3C4352 gui=NONE cterm=NONE
  ...
  hi WinBarNC guifg=#3C4352 guibg=#FFFFFF gui=NONE cterm=NONE
  hi ExplorerSnack guibg=#293652 guifg=#FFFFFF gui=bold cterm=bold
  hi BufferTabpageFill guibg=#FFFFFF guifg=#4A5467 gui=NONE cterm=NONE
  ...
  hi BufferVisibleMod guifg=#3C4352 guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferVisibleSign guifg=#4B5B7D guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferInactive guifg=#4A5467 guibg=#FFFFFF gui=NONE cterm=NONE
...
hi DiffChange guifg=#FFFFFF guibg=#657BA3 gui=NONE cterm=NONE
hi DiffDelete guifg=#FFFFFF guibg=#657DA3 gui=NONE cterm=NONE
hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE
...
hi TelescopeMultiSelection guibg=#9AB4E6 guifg=#2E3440 gui=bold cterm=bold
hi TelescopeMatching guifg=#7A96C2 guibg=NONE gui=bold cterm=bold
...
hi Visual guibg=#CCE0FF guifg=#2E3440 gui=bold
hi CursorLine guibg=NONE ctermbg=NONE gui=underline cterm=underline
hi PmenuSel guibg=#CCE0FF guifg=#2E3440 gui=bold
hi WildMenu guibg=#CCE0FF guifg=#2E3440 gui=bold
